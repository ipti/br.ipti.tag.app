...
import 'details_item_stock/bloc/detail_item_stock_bloc.dart';
...
class StockModule extends Module {
  ...
  final List<Bind> binds = [
    ...
    Bind.lazySingleton((i) => GetItemStockUsecase(i.get())),
    Bind.lazySingleton((i) => DetailItemStockBloc(i.get())),
  ];
  ...
  final List<ModularRoute<void>> routes = [
    ...
    ChildRoute(
      "/ingrediente",
      child: (_, args) => DetailsItemStockPage(ingredientId: args.data),
    ),
  ];
}
