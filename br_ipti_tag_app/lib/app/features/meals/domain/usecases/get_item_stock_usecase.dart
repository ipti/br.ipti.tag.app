...
class GetItemStockUsecase implements Usecase<InvetoryIngredient, IdParams> {
  GetItemStockUsecase(this._repositoryIngredient);

  final IngredientRepository _repositoryIngredient;

  @override
  Future<Either<Exception, InvetoryIngredient>> call(
    IdParams params,
  ) async {
    InvetoryIngredient dumb = InvetoryIngredient(
    ...
    return right(dumb);
    // final result = await _repositoryIngredient.getById(params.objectId);
    // return result;
  }
}
