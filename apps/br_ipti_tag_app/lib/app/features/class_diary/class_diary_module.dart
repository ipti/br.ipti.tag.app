...
import 'package:br_ipti_tag_app/app/features/class_diary/presentation/details_student_class_diary/details_student_class_diary.dart';
...
class ClassDiary extends Module {
  ...
  final List<ModularRoute> routes = [
     ...
     ChildRoute("/detailsstudent", child: (_, args) =>  const DetailsStudentClassDiary()),
