...
class IngredientRepositoryImpl implements IngredientRepository {
  ...
  @override
  Future<Either<Exception, List<InvetoryIngredient>>> list() async {
    try {
  ...
  @override
  Future<Either<Exception, InvetoryIngredient>> getById(String objectId) async {
    try {
      final result = await remoteDataSource.getById(objectId);
      return Right(result);
    } catch (e) {
      return Left(
        Exception("Não foi possível ler dados do JSON"),
