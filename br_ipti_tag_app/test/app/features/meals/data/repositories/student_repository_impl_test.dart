...
void main() {
  group("When listAll", () {
    ...
    testWidgets("has right value", (tester) async {
      when(() => datasource.listAll(schoolId: "schoolId"))
  ...
  group("When getById", () {
    final datasource = MockStudentRemoteDataSource();
    testWidgets("has right value", (tester) async {
      when(() => datasource.getById('', schoolId: ''))
  ...
  group("When create", () {
    final datasource = MockStudentRemoteDataSource();
    testWidgets("has right value", (tester) async {
      when(() => datasource.create(StudentModel()))
          .thenAnswer((invocation) => Future.value(StudentModel()));

      final repository = StudentRepositoryImpl(datasource);
      final params = await repository.create(Student());
    ...
    testWidgets("has left value", (tester) async {
      when(() => datasource.create(StudentModel())).thenThrow(
  ...
  group("When update", () {
    ...
    testWidgets("has left value", (tester) async {
      ...
      final repository = StudentRepositoryImpl(datasource);
      final params = await repository.create(StudentModel());
  ...
  group("When delete", () {
    ...
    testWidgets("has left value", (tester) async {
      when(() => datasource.delete("")).thenThrow(
