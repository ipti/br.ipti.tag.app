...
class ClassroomModel extends ClassroomEntity {
  ...
  factory ClassroomModel.fromJson(Map<String, dynamic> map) {
    return ClassroomModel(
      ...
      modalityId: map['modality'] ?? 0,
      typePedagogicMediationId: map['pedagogical_mediation_type'] ?? 0,
      stage: map['edcenso_stage_vs_modality_fk'] ?? "0",
      edcensoStageVsModalityFk: map['edcenso_stage_vs_modality_fk'] ?? "0",
