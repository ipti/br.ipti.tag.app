          ...
          children: [
              ...
              children: [
                ...
                Padding(
                  ...
                  child: TagButton(
                    ...
                    onPressed: () => Modular.to.pushReplacementNamed("/biometrics/students/"),
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.all(8.0),
            ...
            StreamBuilder<SignState?>(
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.data?.event.code == BioEvents.fingerDected.code) fingerprintPressed(snapshot.data!.student!.id ?? 0);
