...
class InstructorModel extends Instructor {
  InstructorModel({
    ...
    super.cep,
    super.diffLocation,
    super.areaOfResidence,
    super.cpf,
    super.otherCoursesNone = false,
    super.otherCoursesOther = false,
    super.otherCoursesEthnicEducation = false,
    super.otherCoursesChildAndTeenageRights = false,
    super.otherCoursesSexualEducation = false,
    super.otherCoursesHumanRightsEducation = false,
    super.otherCoursesEnvironmentEducation = false,
    super.otherCoursesFieldEducation = false,
    super.otherCoursesNativeEducation = false,
    super.otherCoursesSpecialEducation = false,
    super.otherCoursesEducationOfYouthAndAdults = false,
    super.otherCoursesHighSchool = false,
    super.otherCoursesBasicEducationFinalYears = false,
    super.otherCoursesBasicEducationInitialYears = false,
    super.otherCoursesPreSchool = false,
    super.otherCoursesNursery = false,
    super.postGraduationNone = false,
    super.postGraduationDoctorate = false,
    super.postGraduationMaster = false,
    super.postGraduationSpecialization = false,
    super.highEducationInstitutionCode3Fk = false,
    super.highEducationFinalYear3 = false,
    super.highEducationInitialYear3 = false,
    super.highEducationCourseCode3Fk = false,
    super.highEducationFormation3 = false,
    super.highEducationSituation3 = false,
    super.highEducationInstitutionCode2Fk = false,
    super.highEducationFinalYear2 = false,
    super.highEducationInitialYear2 = false,
    super.highEducationCourseCode2Fk = false,
    super.highEducationFormation2 = false,
    super.highEducationSituation2 = false,
    super.highEducationInstitutionCode1Fk = false,
    super.highEducationFinalYear1 = false,
    super.highEducationInitialYear1 = false,
    super.highEducationCourseCode1Fk = false,
    super.highEducationFormation1 = false,
    super.highEducationSituation1 = false,
    super.hash,
    super.deficiencyTypeGifted = false,
    super.deficiencyTypeAutism = false,
    super.deficiencyTypeMultipleDisabilities = false,
    super.deficiencyTypeIntelectualDisability = false,
    super.deficiencyTypePhisicalDisability = false,
    super.deficiencyTypeDeafblindness = false,
    super.deficiencyTypeDisabilityHearing = false,
    super.deficiencyTypeDeafness = false,
    super.deficiencyTypeLowVision = false,
    super.deficiencyTypeBlindness = false,
    super.filiation2,
    super.filiation1,
    super.filiation,
    super.nis,
