...
class SchoolModel extends School {
  ...
  factory SchoolModel.fromMap(Map<String, dynamic> map) {
    return SchoolModel(
      ...
      managerRole: map['manager_role']?.toInt(),
      managerEmail: map['manager_email'],
      managerAccessCriterion: map['manager_access_criterion'],
      managerContractType: map['manager_contract_type']?.toInt(),
      situation: map['situation']?.toInt(),
      ...
      administrativeDependence: map['administrative_dependence']?.toInt(),
      location: map['location']?.toInt(),
      idDifflocation: map['id_difflocation']?.toInt(),
      linkedMec: map['linked_mec'],
      linkedArmy: map['linked_army'],
      linkedHelth: map['linked_helth'],
      linkedOther: map['linked_other'],
      privateSchoolCategory: map['private_school_category']?.toInt(),
      publicContract: map['public_contract']?.toInt(),
      privateSchoolBusinessOrIndividual:
      ...
      regulation: map['regulation']?.toInt(),
      regulationOrgan: map['regulation_organ']?.toInt(),
      ...
      offerOrLinkedUnity: map['offer_or_linked_unity']?.toInt(),
